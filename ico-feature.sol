...
contract Crowdsale is Pausable {
    ...
    function Crowdsale(uint _dollarPerEtherRatio, uint _maxCap, uint _minCap, uint _tokenPriceWei, uint _minInvestWei) public {               

        require(_dollarPerEtherRatio > 0 && _maxCap > 0 && _minCap > 0);
        ...
        maxCap = _maxCap;   // presale maxCap
        minCap = _minCap * (10**18);    // total camapaign minCap   
        minInvestETH = _minInvestWei;  // presale minInvestETH   
